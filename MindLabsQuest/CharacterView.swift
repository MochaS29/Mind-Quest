                ...
                HStack(spacing: 20) {
                    HStack(spacing: 4) {
                        Image(systemName: "burst.fill")
                            .foregroundColor(.red)
                            .font(.caption)
                        Text("ATK \(gameManager.character.attackPower)")
                            .font(MindLabsTypography.caption())
                            .foregroundColor(.mindLabsText)
                    }
                    HStack(spacing: 4) {
                        Image(systemName: "shield.fill")
                            ...
                            .font(.caption)
                        Text("DEF \(gameManager.character.defensePower)")
                            .font(MindLabsTypography.caption())
                            .foregroundColor(.mindLabsText)
                    }
                }
...
struct ClassAbilitiesCard: View {
    ...
    var abilities: [String] {
        ...
        case .warriorKing:
            return ["Leadership mastery", "Royal command", "Inspire allies"]
        case .pirate:
            return ["Double XP from adventure tasks", "Treasure hunting", "Sea mastery"]
        case .iceMage:
            return ["Double XP from academic tasks", "Frost spells", "Crystal clarity"]
        case .necromancer:
            return ["Dark arts mastery", "Spirit communication", "Ancient knowledge"]
        case .dragon:
            return ["Fire breath", "Legendary strength", "Treasure hoarding"]
        case .angel:
            return ["Divine protection", "Healing aura", "Flight mastery"]
        case .none:
            return []
        }
    }
