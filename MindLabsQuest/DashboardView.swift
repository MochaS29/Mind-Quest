                ...
                VStack(alignment: .leading, spacing: 5) {
                    ...
                    GeometryReader { geometry in
                        ZStack(alignment: .leading) {
                            ...
                            Rectangle()
                                .fill(LinearGradient(colors: [Color.yellow.opacity(0.8), Color.orange], startPoint: .leading, endPoint: .trailing))
                                .frame(width: geometry.size.width * CGFloat(gameManager.energyManager.currentEnergy) / CGFloat(max(1, gameManager.energyManager.maxEnergy)), height: 8)
                                .cornerRadius(4)
                        }
                    }
                    .frame(height: 8)
